...
void fallingnum()
{
	...
	if((ycord==45 && xcord==x+1) || (y3cord==45 && x3cord==x+1) || (y6cord==45 && x6cord==x+1))						//checks for catching numbers on the tray
	{
		a[45][17]=a[0][j];
		conversion(a[0][j]);
		ycord=0;
	...
	else if((ycord==45 && xcord==x+2) || (y3cord==45 && x3cord==x+2) || (y6cord==45 && x6cord==x+2)	)		//check2
	{
		a[45][18]=a[0][j];
		conversion(a[0][j]);
		ycord=0;
	...
	else if((ycord==45 && xcord==x+3) || (y3cord==45 && x3cord==x+3) || (y6cord==45 && x6cord==x+3))		//check3
	{
		a[45][19]=a[0][j];
		conversion(a[0][j]);
		ycord=0;
	...
	if((y1cord==44 && x1cord==x+1) || (y4cord==44 && x4cord==x+1) || (y7cord==44 && x7cord==x+1))						//check 1
	{
		a[45][17]=a[0][j1];
		conversion(a[0][j1]);
		y1cord=0;
	...
	else if((y1cord==44 && x1cord==x+2) || (y4cord==44 && x4cord==x+2) || (y7cord==44 && x7cord==x+2))		//check2
	{
		a[45][18]=a[0][j1];
		conversion(a[0][j1]);
		y1cord=0;
	...
	else if((y1cord==44 && x1cord==x+3) || (y4cord==44 && x4cord==x+3) || (y7cord==44 && x7cord==x+3))		//check3
	{
		a[45][19]=a[0][j1];
		conversion(a[0][j1]);
		y1cord=0;
	...
	if((y2cord==45 && x2cord==x+1) ||  (y5cord==45 && x5cord==x+1) || (y8cord==45 && x8cord==x+1))						//check 1
	{
		a[45][17]=a[0][j2];
		conversion(a[0][j2]);
		y2cord=0;
	...
	else if((y2cord==45 && x2cord==x+2)	|| (y5cord==45 && x5cord==x+2) || (y8cord==45 && x8cord==x+2))	//check2
	{
		a[45][18]=a[0][j2];
		conversion(a[0][j2]);
		y2cord=0;
	...
	else if((y2cord==45 && x2cord==x+3) || (y5cord==45 && x5cord==x+3) || (y8cord==45 && x8cord==x+3))		//check3
	{
		a[45][19]=a[0][j2];
		conversion(a[0][j2]);
		y2cord=0;
